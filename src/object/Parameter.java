...
public class Parameter {
	...
	public Parameter(Dataset dataset) {
		this.root_path = "C:\\Users\\Desktop\\PhD\\iCONF";
		
		this.dataset = dataset;
		
		this.output_add = root_path + "\\Exp Results\\results.csv";
		
		this.dataset_add = root_path + "\\Dataset\\"+dataset.name+".csv";
	...
	public Parameter(Dataset dataset, String rootDir) {
		this.root_path = rootDir;
